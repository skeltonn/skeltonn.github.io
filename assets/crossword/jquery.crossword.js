        ...
        */
            ...
            calcCoords: function () {
                ...
                */
                for (var i = 0, p = entryCount; i < p; ++i) {
                    entries[i] = [];
                    var sx = puzz.data[i].startx;
                    var sy = puzz.data[i].starty;
            ...
            buildEntries: function () {
                ...
                for (var x = 1, p = entryCount; x <= p; ++x) {
                    ...
                    for (var i = 0; i < entries[x - 1].length; ++i) {
                        ...
                        // check if POSITION property of the entry on current go-round is same as previous. If so, it means there's an across & down entry for the position.
        ...
        var util = {
            highlightEntry: function () {
                // this routine needs to be smarter because it doesn't need to fire every time, only when activePosition changes
                $actives = $('.active');
            ...
            getActivePositionFromClassGroup: function (el) {
                ...
                if (classes.length > 1) {
                    ...
                    // test if clicked input is first in series. If so, and it intersects with entry of opposite orientation, switch to select this one instead
